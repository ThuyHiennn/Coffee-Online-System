...
namespace CoffeeOnlineSystem.Models
{
    public class account
    {
        ...
        [RegularExpression("^([0]\\d{9})$|^((\\+84)\\d{9})$", ErrorMessage =  "Email invalid")]
        [Display(Name = "Phone")]
    ...
    class customertList
    {
        ...
        public List<account> getCustomer(int? id)
        {
            ...
            {
                sql = "select * from account where IDUser='" + id +"' && IDRole='1'";
            }
        ...
        {
            string sql = "delete products where IDUser='" + id + "'&& IDRole='1'";
            SqlConnection con = db.GetConnection();
